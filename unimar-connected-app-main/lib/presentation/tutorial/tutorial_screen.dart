...
class _TutorialScreenState extends State<TutorialScreen> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 12),
          Text(subtitle, style: TextStyle(fontSize: 16, color: Colors.white70), textAlign: TextAlign.center),
          SizedBox(height: 24),
          Container(
            height: 220,
            ...
            child: Center(child: Text('Illustration', style: TextStyle(color: Colors.white38))),
          )
        ],
      ),
    );
  ...
  Widget build(BuildContext context) {
    final pages = [
      _buildPage(title: 'Bem-vindo', subtitle: 'Organize e confirme seu transporte com QR code'),
      _buildPage(title: 'Gerar Ticket', subtitle: 'Receba QR code com seu horário e bloco.'),
      _buildPage(title: 'Validação', subtitle: 'Motoristas validam com scanner ou busca manual.'),
    ];
